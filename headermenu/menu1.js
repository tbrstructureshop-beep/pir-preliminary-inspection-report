/**
 * menu1.js - Final Inline Responsive Version (Fixed Mobile Sliding & Unit Clipping)
 */
...
const PIR_MENU = {
    ...
    injectStyles() {
        const css = `
            ...
            /* 20px extra buffer below header */
            body { 
                margin: 0; 
            ...
            .header-right.active .info-reveal-container { 
                max-width: 600px; /* Increased for longer unit names */
                opacity: 1; margin-right: 12px; pointer-events: auto;
            }

            /* FIX FOR MOBILE CLIPPING */
            @media (max-width: 768px) {
                .main-header.info-open .brand-name { 
                    display: none; /* Remove brand to make room */
                }
                .header-right.active .info-reveal-container { 
                    /* Use most of the screen width minus button and avatar space */
                    max-width: calc(100vw - 110px); 
                }
                .header-name-row, .header-detail-row {
                    overflow: hidden;
            ...
            .sidebar-user-info { margin-top: 12px; border-top: 1px solid #ddd; padding-top: 12px; }
            .side-name { font-weight: 700; color: var(--primary); font-size: 14px; line-height: 1.2; }
            .side-unit { font-size: 11px; color: #666; font-weight: 600; margin-top: 4px; text-transform: uppercase; }
